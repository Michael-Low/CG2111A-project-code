...
// caCertFilename = CA's certificate filename. Needed only if verifyPeer is
// true. verifyPeer = Set to true to force verification of client's identity

void createServer(const char *keyFilename, const char *certFilename,
                  int portNum, void *(*workerThread)(void *),
                  const char *caCertFilename, const char *clientName,
                  int verifyPeer) {
...
int server_is_running() { return !_exitFlag; }
